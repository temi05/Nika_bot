...
function isLowValueEphemeralMemory(text) {
    ...
    const blockedRegexes = [
        ...
        /\bсегодня\s+(хочу|буду|собираюсь|пойду|планирую)\b/i,
        /\bзавтра\s+(хочу|буду|собираюсь|пойду|планирую)\b/i,
        /\b(вечером|утром|ночью|днем)\s+(хочу|буду|собираюсь|пойду|планирую)\b/i,
        /\bна\s+(выходных|неделе|следующей\s+неделе)\b/i,
        /\bпланы?:\b/i,
        /\bсегодня\b.*\bстрим\b/i,
        /\bзавтра\b.*\bстрим\b/i,
        /\bбудет\s+стрим\b/i,
        /\bпотом\s+зайду\b/i,
        /^\s*(ща|щас|ладно)\s*$/i
    ];
