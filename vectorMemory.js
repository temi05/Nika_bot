...
2. Биография и Статус: Имя, возраст, город, профессия.
3. Глобальные Хобби: "фанат аниме".
4. Здоровье и Техника: Аллергии, фобии, ПК, авто.

[ЧЕРНЫЙ СПИСОК (Мгновенно в мусорку)]:
❌ Бытовуха и Еда: "хочет шаурму", "пьет пиво", "идет спать".
❌ Временные состояния: "на работе", "заболела голова", "устал".
❌ Временные планы: "через 2 дня позовут в игру".
❌ Запросы к боту: "Ника, запомни это".
...
{
  "facts": [
    { "name": "Sanechk_aaa", "fact": "хочет доминировать над Никой и ставить её на колени" },
