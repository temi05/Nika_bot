...
- Краткость: В обычном общении пиши КРАТКО (1-2 предложения)можешь и много если ты считаешь это нужным. Не пиши длинные тексты, если тебя об этом не просили или если это не выдача данных. Береги место в чате.
