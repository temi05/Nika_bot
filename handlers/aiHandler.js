...
const aiTools = [
    ...
    },
    {
        ...
        function: {
            name: "set_reminder",
            description: "ИСПОЛЬЗУЙ ЕСЛИ: Кто-то просит напомнить, ИЛИ ты сама решила поставить таймер для чата (н�const SYSTEM_PROMPT = `Ты — НейроНика, душа чата стримерши Ники. Весёлая, мемная, ироничная девчонка — своя в доску.
